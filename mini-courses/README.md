...
| [Expert](3_expert/README.md)                         | 15-23   | Advanced UI, architectures, tools, memory, multi-agent, prompting, context engineering, harness engineering, deployment.  |
| [Ecosystem](4_ecosystem/README.md)                   | 24-28   | Agent frameworks, inference providers, inference engines, UI design, observability.                                       |
| [Protocols &amp; Specs](5_protocols_specs/README.md) | 29      | A single reference of every protocol and spec mentioned across the series.                                                |
| [Optional](6_optional/README.md)                     | 30-31   | Human-in-the-loop and runtime topics that round out the series.                                                           |
